...
class ProductBookmark extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <View style={Styles.container}>
                ...
                >
                    ...
                    <View style={Styles.Title_H1}>
                        ...
                        <Text style={Styles.contentTitle_h1}>{this.props.mutilanguge.bookmark}</Text>
                        <TouchableWithoutFeedback onPress={() => {
    ...
    _getProductHistory = async () => {
        try {
          const value = await AsyncStorage.getItem('bookmark@logistic');
          var flag_product = [];
          var get_product = [];
          var str_product = '';
          if (value !== null) {
...
export default connect(mapStateToPropsRefesh)(ProductBookmark);
