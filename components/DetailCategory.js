...
class DetailCategory extends Component {
          ...
          <View style={Styles.Header_Logo} >
            ...
            <View style={Styles.body} style={{flex:1}}>
              ...
              <View style={Styles.title}>
                  ...
                  <Text style={Styles.contentTitle}>{this.props.mutilanguge.detailProductCategory}</Text>
              </View>
              <View style={{flex:1}}>
              <ListView
  ...
  loadNewData(){
    ...
    fetch("http://xanhluc.com:32000/aws/e/items-by-category-id/?id="+this.state.params+"&limit=10&page="+this.state.page)
...
export default connect(mapStateToPropsRefesh)(DetailCategory);
